...
//   return (
//     <div id="services" className="flex flex-col items-center justify-center min-h-screen bg-black text-white px-6">
//       {/* Centered Header */}
//       <h1 className="mt-10 text-4xl md:text-6xl lg:text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-neutral-50 to-neutral-400 text-center max-w-5xl">
//         Services
//       </h1>
