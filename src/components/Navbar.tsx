...
//     <div className={cn("fixed top-0 inset-x-0 max-w-2xl mx-auto z-50", className)}>
//       {/* Hamburger for mobile */}
//       <div className="lg:hidden flex justify-end px-6 pt-4">
//         <button 
//           onClick={() => setIsOpen(!isOpen)} 
//           className="text-white dark:text-white hover:bg-white/20 rounded-lg p-2 transition-all duration-200 backdrop-blur-sm"
//         >
//           {isOpen ? <X size={28} /> : <MenuIcon size={28} />}
//         </button>
//       </div>
...
//             "hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm",
//             active === "home" && "bg-white/20 text-white"
//           )}
//         >
//           Home
//         </a>
...
//             "text-white/90 hover:text-white transition-all duration-200",
//             "hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm",
//             active === "skill" && "bg-white/20 text-white"
//           )}
//         >
//           Skills
//         </a>
...
//             "text-white/90 hover:text-white transition-all duration-200",
//             "hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm",
//             active === "project" && "bg-white/20 text-white"
//           )}
//         >
//           Projects
//         </a>
...
//             "text-white/90 hover:text-white transition-all duration-200",
//             "hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm",
//             active === "service" && "bg-white/20 text-white"
//           )}
//         >
//           Services
//         </a>
...
//             "text-white/90 hover:text-white transition-all duration-200",
//             "hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm",
//             active === "contact" && "bg-white/20 text-white"
//           )}
//         >
//           Contact
//         </a>
