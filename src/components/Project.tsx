      ...
      <div className="mt-12 flex flex-wrap justify-center gap-8">
        ...
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] max-w-[30rem] h-auto rounded-xl p-6 border">
            ...
            <CardItem as="p" translateZ="60" className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300">
            A secure and intuitive platform for users to share thoughts anonymously, enhanced with AI-powered assistance. Built with React, Node.js, Express.js, and MongoDB for scalability and seamless user experience.
            </CardItem>
 ...
 <div className="mt-12 flex flex-wrap justify-center gap-8">
      <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] max-w-[30rem] h-auto rounded-xl p-6 border">
            ...
            <CardItem as="p" translateZ="60" className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300">
            An AI-powered mental peace support chatbot system offering personalized assistance and emotional support. Built with React, Node.js, Express.js, and MongoDB, it ensures seamless interactions and a secure user experience.
            </CardItem>
