  ...
  return (
    <nav
      ...
      className={cn(
        ...
        // Desktop styles
        "lg:relative lg:rounded-full lg:border lg:dark:bg-black lg:dark:border-white/[0.2] lg:bg-white ",
        "lg:flex lg:flex-row lg:space-x-4 lg:px-8 lg:py-6 lg:justify-center lg:items-center",
        // Mobile styles
        "fixed top-16 left-4 right-4 bg-white dark:bg-black rounded-xl shadow-lg",
